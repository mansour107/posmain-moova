            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><a href="add_hiringcontract.php" class="btn btn-large btn-primary"> <?= $lang_add_new ?></a></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <?php
                            $sql = "SELECT `id` , `employee` , `jop` , `salary` FROM  `hiringcontracts` WHERE `type` = 0 AND isdeleted is NULL";
