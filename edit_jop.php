            ...
            <form role="form" action="do/doedit_jop.php?id=<?= $id ?>" method="post">
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input value="<?= $rowjop['name'] ?>" name="name" type="text" class="form-control" placeholder="<?= $lang_plholder_jop ?>" required>
                </div>
                <div class="form-group">
                  <label><?= $lang_publicinfo ?></label>
                  <textarea class="form-control" name="info" rows="4" placeholder="أدخل معلومات إضافية"><?= $rowjop['info'] ?></textarea>
                </div>
