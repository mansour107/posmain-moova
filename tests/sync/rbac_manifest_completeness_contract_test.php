...
$allowlist = [
    ...
    // PHP built-in server front controller; it denies private paths before
    // dispatch and is not an application route handled by the RBAC guards.
    'router.php' => 'Built-in development server router, not an application entry point',
];
