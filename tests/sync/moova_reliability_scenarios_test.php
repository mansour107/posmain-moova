...
foreach ([
    ...
    'Stale edit/cancel',
    'Token viewing is permission-gated and audited',
...
$requiredArtifacts = [
    ...
    'docs/production/moova_token_rotation.md' => ['moova_device_token_viewed', 'Rotate immediately'],
    ...
    'tests/sync/moova_token_visibility_security_test.php' => ['moova_device_token_viewed', 'auth_guard_has_permission'],
