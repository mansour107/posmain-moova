...
moovaAdminAssertNotContains("moova_device_token_viewed", $page, 'Moova page should never reveal the device token');
...
moovaAdminAssertContains("menu-sync/reconcile", $service, 'save endpoint should push directly to the explicit menu reconcile route');
