...
foreach ([
    'db/DB.sql:904',
    'do/doadd_invoice.php:660',
    'do/doadd_invoice.php:968',
    'do/doadd_invoice.php:973',
    'do/doadd_invoice.php:1394',
    ...
    'do/doedit_item.php:137',
    'do/doedit_item.php:207',
    'do/doedit_item.php:217',
    'do/doedit_item.php:256',
    'do/toggle_item_active.php:19',
...
foreach ([
    ...
    ['do/doadd_invoice.php', 660, 'UPDATE fat_details'],
    ['do/doadd_invoice.php', 968, 'UPDATE fat_details SET isdeleted = 1'],
    ['do/doadd_invoice.php', 973, 'DELETE FROM fat_details'],
    ['do/doadd_invoice.php', 1357, 'INSERT INTO fat_details'],
    ['do/doadd_invoice.php', 1368, 'SELECT cost_price, itmqty FROM myitems'],
    ['do/doadd_invoice.php', 1374, 'UPDATE myitems SET last_price'],
    ['do/doadd_invoice.php', 1394, 'PURCHASE_ORDER'],
    ['do/doadd_invoice.php', 1400, '$qty_in = $itmqty * $u_val'],
    ['do/doadd_invoice.php', 1405, '$qty_out = $itmqty * $u_val'],
    ['do/doadd_invoice.php', 1457, '$stmt_details->bind_param'],
    ['do/doadd_invoice.php', 1500, 'recordInvoiceLines'],
    ['components/pos_clothes/order_form.php', 9, 'action="do/doadd_invoice.php"'],
    ['components/pos_clothes/order_form.php', 10, "csrf_input('pos_browser')"],
    ...
    ['do/doedit_invoice.php', 509, 'recordInvoiceReversalLines'],
    ['do/doedit_invoice.php', 530, 'UPDATE fat_details SET isdeleted = 1'],
    ['do/doedit_invoice.php', 539, 'INSERT INTO fat_details'],
    ['do/doedit_invoice.php', 40, 'PURCHASE_ORDER'],
    ['do/doedit_invoice.php', 580, '$qty_in = $itmqty * $u_val'],
    ['do/doedit_invoice.php', 585, '$qty_out = $itmqty * $u_val'],
    ['do/doedit_invoice.php', 666, 'recordInvoiceLines'],
    ...
    ['do/doadd_item.php', 57, 'INSERT INTO myitems'],
    ['do/doadd_item.php', 101, 'ItemUnitPersistence::saveForItem'],
    ['classes/Items/ItemUnitPersistence.php', 25, 'INSERT INTO item_units'],
    ['classes/Items/ItemUnitPersistence.php', 143, 'DELETE FROM item_units'],
    ...
    ['save_start_balance.php', 195, 'UPDATE fat_details'],
    ['save_start_balance.php', 237, 'INSERT INTO fat_details'],
    ['save_start_balance.php', 344, 'UPDATE inventory_movements'],
    ['save_start_balance.php', 413, 'INSERT INTO inventory_movements'],
    ['save_start_balance.php', 655, 'INSERT INTO inventory_item_balances'],
    ...
    ['classes/Inventory/InventoryInvoiceBridge.php', 330, 'recordShadowMovement'],
    ['classes/Inventory/InventoryInvoiceBridge.php', 331, 'recordMovement'],
    ['classes/Inventory/InventoryInvoiceBridge.php', 81, 'postAccountingForMovements'],
    ['classes/Inventory/InventoryInvoiceBridge.php', 380, 'postSaleCogs'],
    ['classes/Inventory/InventoryInvoiceBridge.php', 392, 'postRefundReversal'],
    ['classes/Inventory/InventoryInvoiceBridge.php', 129, 'reversalMovementTypeForOriginal'],
    ...
    ['classes/Inventory/InventoryLedgerService.php', 374, 'UPDATE myitems SET itmqty'],
    ['classes/Inventory/InventoryLedgerService.php', 374, 'UPDATE myitems SET itmqty'],
    ['classes/Inventory/InventoryLedgerService.php', 374, 'UPDATE myitems SET itmqty'],
    ['classes/Sync/CloudLegacyPosMirrorService.php', 509, 'INSERT INTO myitems'],
    ['do/doedit_item.php', 146, 'posmain_edit_item_save_units'],
    ['do/doedit_item.php', 232, 'UPDATE item_units'],
    ['do/doedit_item.php', 242, 'INSERT INTO item_units'],
    ['do/doedit_item.php', 281, 'DELETE FROM item_units'],
    ['classes/Pos/Service/PosOrderMutationService.php', 61, 'new InventoryMovementService()'],
    ['classes/Pos/Service/PosOrderMutationService.php', 680, 'normalizeInvoiceLines'],
    ...
    ['classes/Inventory/InventoryLedgerService.php', 130, 'createMovement'],
    ['classes/Inventory/InventoryLedgerService.php', 131, 'putBalance'],
    ['classes/Inventory/InventoryLedgerService.php', 143, 'writeAudit'],
    ...
    ['classes/Recipe/RecipeOrderLifecycleService.php', 101, 'reserveExplosion'],
    ['classes/Recipe/RecipeOrderLifecycleService.php', 151, 'releaseForUsageIds'],
    ['classes/Recipe/RecipeOrderLifecycleService.php', 300, 'consumeForOrderLine'],
    ['classes/Recipe/RecipeOrderLifecycleService.php', 300, 'consumeForOrderLine'],
    ['classes/Recipe/RecipeOrderLifecycleService.php', 782, 'recordRefundReversal'],
    ['recipe_production.php', 28, 'ProductionBatchMutationService'],
    ['classes/Recipe/ProductionBatchMutationService.php', 46, 'createDraft'],
    ['classes/Recipe/ProductionBatchMutationService.php', 59, 'commit'],
    ['classes/Recipe/ProductionBatchMutationService.php', 68, 'cancel'],
    ...
    ['classes/Recipe/RecipeCostService.php', 70, 'createSnapshot'],
    ['classes/Recipe/Repository/RecipeCostSnapshotRepository.php', 26, 'insertRow($conn, \'recipe_cost_snapshots\''],
    ['classes/Recipe/RecipeOrderLifecycleService.php', 460, 'createUsage'],
    ['classes/Recipe/RecipeOrderLifecycleService.php', 508, 'refreshForOrderLine'],
    ...
    ['classes/Pos/Service/ItemVariantService.php', 830, 'DELETE FROM item_units'],
    ['classes/Pos/Service/ItemVariantService.php', 837, 'INSERT INTO item_units'],
    ...
    ['classes/Recipe/RecipeInventoryMovementService.php', 673, 'recordMovement'],
    ['classes/Recipe/RecipeInventoryMovementService.php', 673, 'recordMovement'],
    ['classes/Recipe/RecipeInventoryMovementService.php', 856, 'INSERT IGNORE INTO inventory_item_balances'],
    ...
    ['tools/inventory_backfill_from_fat_details.php', 31, '$apply'],
    ['tools/inventory_backfill_from_fat_details.php', 72, 'applyFatDetailsBackfill'],
    ...
    ['classes/Inventory/InventoryHistoricalMigrationService.php', 239, 'recordMovement'],
    ['classes/Inventory/InventoryHistoricalMigrationService.php', 429, 'putBalance'],
    ['classes/Inventory/InventoryReconciliationRepairService.php', 92, 'refreshItemQtySummary'],
    ['ajax/inventory_purchase_receive.php', 34, 'returnItems'],
    ...
    ['ajax/inventory_adjustment.php', 53, 'recordWaste'],
    ['ajax/inventory_adjustment.php', 56, 'recordAdjustment'],
] as $lineProof) {
    inventoryWritePathAssert(
...
foreach ([
    ['myitems.php', 193, 'stock_qty_display'],
    ...
    ['classes/Inventory/InventoryReportsService.php', 54, 'qty_on_hand'],
    ...
    ['classes/Inventory/InventoryStockLevelService.php', 42, 'INSERT INTO inventory_item_stock_levels'],
    ['classes/Inventory/InventoryStockLevelService.php', 59, 'INSERT INTO inventory_item_stock_levels'],
    ['ajax/inventory_stock_level_save.php', 27, 'save($conn'],
    ...
    ['classes/Inventory/InventoryPurchaseOrderService.php', 167, 'UPDATE inventory_purchase_orders SET status'],
    ['classes/Inventory/InventoryPurchaseOrderService.php', 194, 'INSERT INTO inventory_purchase_orders'],
    ['classes/Inventory/InventoryPurchaseOrderService.php', 217, 'INSERT INTO inventory_purchase_order_lines'],
    ['classes/Inventory/InventoryPurchaseReceivingService.php', 282, 'INSERT INTO inventory_purchase_receipts'],
    ['classes/Inventory/InventoryPurchaseReceivingService.php', 434, 'INSERT INTO inventory_purchase_receipt_lines'],
    ['classes/Inventory/InventoryPurchaseReceivingService.php', 462, 'UPDATE inventory_purchase_receipt_lines SET inventory_movement_id'],
    ...
    ['classes/Inventory/InventoryTransferService.php', 605, 'INSERT INTO inventory_transfers'],
    ['classes/Inventory/InventoryTransferService.php', 639, 'INSERT INTO inventory_transfer_lines'],
    ['classes/Inventory/InventoryTransferService.php', 654, 'UPDATE inventory_transfer_lines SET sent_qty'],
    ['classes/Inventory/InventoryTransferService.php', 662, 'UPDATE inventory_transfer_lines SET variance_qty'],
    ['classes/Sync/SchemaManager.php', 1561, 'CREATE TABLE IF NOT EXISTS recipe_order_line_usage'],
    ['classes/Sync/SchemaManager.php', 1610, 'CREATE TABLE IF NOT EXISTS inventory_movements'],
    ['classes/Sync/SchemaManager.php', 1661, 'CREATE TABLE IF NOT EXISTS inventory_item_balances'],
    ['classes/Sync/SchemaManager.php', 1685, 'CREATE TABLE IF NOT EXISTS inventory_item_stock_levels'],
    ['classes/Sync/SchemaManager.php', 1737, 'CREATE TABLE IF NOT EXISTS inventory_counts'],
    ['classes/Sync/SchemaManager.php', 1799, 'CREATE TABLE IF NOT EXISTS inventory_transfers'],
    ['classes/Sync/SchemaManager.php', 1863, 'CREATE TABLE IF NOT EXISTS inventory_purchase_orders'],
    ['classes/Sync/SchemaManager.php', 1916, 'CREATE TABLE IF NOT EXISTS inventory_purchase_receipts'],
] as $readLineProof) {
    inventoryWritePathAssert(
...
function inventoryWritePathSourceLineContains(string $root, string $relativePath, int $lineNumber, string $needle): bool
{
    ...
    if (isset($lines[$lineNumber - 1]) && strpos($lines[$lineNumber - 1], $needle) !== false) {
        return true;
    }

    $start = max(0, $lineNumber - 75);
    $end = min(count($lines), $lineNumber + 75);
    for ($i = $start; $i < $end; $i++) {
        if (strpos($lines[$i], $needle) !== false) {
            return true;
        }
    }
