...
foreach ([
    ...
    ['do/doedit_item.php', 137, 'posmain_edit_item_save_units'],
    ['do/doedit_item.php', 207, 'UPDATE item_units'],
    ['do/doedit_item.php', 217, 'INSERT INTO item_units'],
    ['do/doedit_item.php', 256, 'DELETE FROM item_units'],
...
foreach ([
    ...
    ['classes/Sync/SchemaManager.php', 1505, 'CREATE TABLE IF NOT EXISTS recipe_order_line_usage'],
    ['classes/Sync/SchemaManager.php', 1554, 'CREATE TABLE IF NOT EXISTS inventory_movements'],
    ['classes/Sync/SchemaManager.php', 1605, 'CREATE TABLE IF NOT EXISTS inventory_item_balances'],
    ['classes/Sync/SchemaManager.php', 1629, 'CREATE TABLE IF NOT EXISTS inventory_item_stock_levels'],
    ['classes/Sync/SchemaManager.php', 1681, 'CREATE TABLE IF NOT EXISTS inventory_counts'],
    ['classes/Sync/SchemaManager.php', 1743, 'CREATE TABLE IF NOT EXISTS inventory_transfers'],
    ['classes/Sync/SchemaManager.php', 1807, 'CREATE TABLE IF NOT EXISTS inventory_purchase_orders'],
    ['classes/Sync/SchemaManager.php', 1860, 'CREATE TABLE IF NOT EXISTS inventory_purchase_receipts'],
] as $readLineProof) {
    inventoryWritePathAssert(
