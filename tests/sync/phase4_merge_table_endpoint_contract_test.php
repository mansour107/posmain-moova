...
phase4MergeEndpointAssert(substr_count($source, 'recordOrderSnapshot') >= 2, 'endpoint should record source and destination order snapshots');
phase4MergeEndpointAssert(substr_count($source, 'recordTableSnapshot') >= 2, 'endpoint should record source and destination table snapshots');
...
phase4MergeEndpointAssert(strpos($source, "'remaining_amount' => (float) (\$merge['remaining_amount'] ?? 0)") !== false, 'response should include remaining_amount');
