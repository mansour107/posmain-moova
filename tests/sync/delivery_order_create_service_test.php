...
deliveryCreateAssert(strpos(file_get_contents($root . '/classes/Pos/Service/PosOrderMutationService.php'), 'upsertForDelivery') !== false, 'delivery create should upsert CRM customers');
