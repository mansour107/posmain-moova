...
phase4CashierLineNoteAssert(strpos($jsSource, "addItemToOrder(id, name, price, barcode, qty = 1, imageHtml = '', lineNote = '')") !== false, 'addItemToOrder should accept an optional line note');
