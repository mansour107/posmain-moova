...
try {
    ...
    inventoryReconciliationAssert(count($rows) === 3, 'reconciliation should return all difference rows');
    ...
    inventoryReconciliationAssert(in_array('non_stock_item_has_stock_movement', $rows[2]['difference_reasons'], true), 'non-stock sellable legacy stock should be categorized');
    inventoryReconciliationAssert(!in_array('missing_bridge_movement', $rows[2]['difference_reasons'], true), 'non-stock sellable legacy stock should not demand a ledger bridge movement');
