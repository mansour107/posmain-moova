...
try {
    ...
    $conn->query("INSERT INTO order_payments VALUES
        (401, 1, 'cash', 40, 7, '2026-07-10 10:02:00', 0),
        (402, 1, 'card', 50, 7, '2026-07-10 10:02:00', 0),
        (403, 2, 'cash', 50, 7, '2026-07-10 11:03:00', 0),
    ...
    operationsReportAssert(abs($sales['net_sales'] - 120.0) < 0.001, 'net sales after discounts and refunds');
    ...
    operationsReportAssert(abs((float) $payments['cash_collected'] - 90.0) < 0.001, 'cash tender excludes voided and other branch rows');
    ...
    operationsReportAssert(abs((float) $payments['net_total'] - 120.0) < 0.001, 'net tenders match net sales');
