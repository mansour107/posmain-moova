...
$expectations = [
    ...
    'myroles.php' => ["page_guard('roles.manage'"],
    'add_role.php' => ["csrf_input('roles_write')", "page_guard('roles.manage'"],
    'edit_role.php' => ["csrf_input('roles_write')", "page_guard('roles.manage'"],
    'myitems.php' => ["page_guard('menu.edit'"],
    'add_item.php' => ["page_guard('menu.edit'"],
    'ajax/delete_order.php' => ["require_permission('pos.cancel.unpaid'"],
