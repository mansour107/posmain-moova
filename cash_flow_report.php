    ...
    <main class="premium-report cash-shift-workspace" id="cashShiftWorkspace">
      ...
      <section class="pr-panel">
        ...
        <div class="pr-panel-body">
          ...
          <div class="pr-table-wrap pr-table-scroll"><table class="pr-table pr-table--compact cash-shift-table"><thead><tr><th>الكاشير</th><th>يوم العمل</th><th>الفترة</th><th>المتوقع</th><th>الفرق</th><th>الحالة</th><th>الإجراءات</th></tr></thead><tbody>
          ...
          <?php endforeach; ?>
          <?php if ($shiftsPage['rows'] === []): ?><tr><td colspan="7"><div class="cash-shift-empty"><i class="fas fa-inbox"></i><strong>لا توجد جلسات مطابقة</strong><span>جرّب تغيير الحالة أو نطاق التاريخ.</span></div></td></tr><?php endif; ?>
          </tbody></table></div>
