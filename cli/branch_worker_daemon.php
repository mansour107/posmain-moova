...
if (isset($options['help'])) {
    fwrite(STDOUT, "Usage: php cli/branch_worker_daemon.php [--once|--loop] [--list|--preflight] [--strict] [--only=sync_outbox,moova_poller,moova_apply,moova_ack] [--batch-size=25] [--sync-batch-size=50] [--moova-batch-size=25] [--sleep=5] [--max-runtime=300]\n");
