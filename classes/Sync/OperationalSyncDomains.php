...
class OperationalSyncDomains
{
    ...
    public static function extendedDomains(): array
    {
        return [
            ...
            'delivery_worker' => self::rowDomain('delivery_workers', 'delivery_worker', 'delivery_worker.saved', 'delivery_workers'),
            'delivery_assignment' => self::rowDomain('delivery_assignments', 'delivery_assignment', 'delivery_assignment.saved', 'delivery_assignments'),
            'delivery_compensation_plan' => self::rowDomain('delivery_compensation_plans', 'delivery_compensation_plan', 'delivery_compensation_plan.saved', 'delivery_compensation_plans'),
            'delivery_compensation_zone_rate' => self::rowDomain('delivery_compensation_zone_rates', 'delivery_compensation_zone_rate', 'delivery_compensation_zone_rate.saved', 'delivery_compensation_zone_rates'),
            'delivery_order_financial' => self::rowDomain('delivery_order_financials', 'delivery_order_financial', 'delivery_order_financial.saved', 'delivery_order_financials'),
            'delivery_settlement' => self::rowDomain('delivery_settlements', 'delivery_settlement', 'delivery_settlement.saved', 'delivery_settlements'),
            'delivery_settlement_line' => self::rowDomain('delivery_settlement_lines', 'delivery_settlement_line', 'delivery_settlement_line.saved', 'delivery_settlement_lines'),
