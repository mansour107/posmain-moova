...
class TeamHubService
{
  ...
  private const PERMISSION_LABELS = [
    ...
    'delivery.assign' => 'تعيين عامل توصيل',
    'delivery.workers.manage' => 'إدارة عمال التوصيل',
    'delivery.compensation.manage' => 'خطط مستحقات التوصيل',
    'delivery.settlements.manage' => 'تسوية عمال التوصيل',
    'delivery.settlements.reverse' => 'عكس تسوية توصيل',
    'delivery.reports.view' => 'تقارير التوصيل',
    'kds.view' => 'عرض المطبخ',
