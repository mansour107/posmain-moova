...
if (!function_exists('auth_guard_permission_map')) {
    function auth_guard_permission_map(): array
    {
        return [
            ...
            'delivery.assign' => ['add_sales', 'edit_sales', 'sid_sales'],
            'delivery.workers.manage' => ['edit_sales', 'edit_items'],
            'delivery.compensation.manage' => ['edit_sales', 'sid_accounts'],
            'delivery.settlements.manage' => ['edit_payment', 'sid_accounts'],
            'delivery.settlements.reverse' => ['__admin_only'],
            'delivery.reports.view' => ['sid_reports', 'sid_accounts', 'edit_sales'],
