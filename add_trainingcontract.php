    ...
    <div class="container-fluid">
      ...
      <div class=" card card-primary">
        <div class="card-header">
          <h3 class="card-title"> <?= $lang_addhicont_newtrianing ?></h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
            ...
            <div class="row">
              <div class="col">
                ...
                <div class="form-group">
                  ...
                  <textarea name="jopdescription" data-parsley-trigger="keyup" requiredid="jopdescription" class="form-control" rows="5"></textarea>
                </div>
              ...
              <div class="col">
                ...
                <div class="form-group">
                  ...
                  <input name="user" type="number" data-parsley-trigger="keyup" required id="user" class="form-control" placeholder="<?= $lang_pbholder_user ?>">
                </div>
