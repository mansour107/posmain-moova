...
Generated at UTC: 2026-05-25T17:13:05Z
Evidence completed at UTC: 2026-05-25T17:14:00Z
Recipe mode: full
POS tenant: 0
POS branch: 0
Store: 27
Operator: Codex local QA
Note: Full-mode evidence extends the validated availability pilot evidence with full-mode reservation gating and the 16-proof runtime suite.
...
- Recipe reservation evidence: tests/sync/recipe_reservation_lifecycle_runtime_test.php recipe-reservation-lifecycle-runtime-ok; reservation lifecycle proof covered add/edit/cancel behavior and qty_reserved accounting.
...
- Isolated runtime proofs: php tools/recipe_runtime_proof_suite.php --include-availability --include-moova-sync --json
