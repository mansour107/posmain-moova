...
Generated at UTC: 2026-05-25T16:45:22Z
Evidence completed at UTC: 2026-05-25T16:53:31Z
Recipe mode: consume_pilot
POS tenant: 0
POS branch: 0
Store: 27
Operator: 
Note: Draft generated by tools/recipe_pilot_evidence_bundle.php; browser/operator action lines are intentionally pending.
...
- Migrated runtime write smoke evidence: tools/recipe_migrated_write_smoke.php --json --apply --run-id=apply-004 stock_preflight ok=true, order_id=998861, idempotency_replayed=true, recipe_consumption movements=16/17, positive movement cost milk=0.004000 cup=0.150000.
