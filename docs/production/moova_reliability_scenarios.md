...
| Device tokens are write-only, encrypted at rest, and never returned to the browser after pairing | `moova_integration.php`, `MoovaPosIntegration`, rotation doc | `php tests/sync/moova_token_visibility_security_test.php` |
