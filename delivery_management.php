  ...
  <section class="content"><div class="container-fluid">
    ...
    <?php else: ?>
      ...
      <section class="delivery-panel is-active" data-panel="overview">
        ...
        <div class="delivery-card"><h3>آخر التسويات</h3><div class="table-responsive"><table class="delivery-table"><thead><tr><th>العامل</th><th>الفترة</th><th>صافي التسوية</th><th>الحالة</th></tr></thead><tbody id="deliveryRecentSettlements"></tbody></table></div></div>
      </section>
