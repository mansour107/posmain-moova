...
if ($newRoleId > 0) {
    ...
    if ($kdsStmt) {
        $kdsStmt->bind_param('ii', $sid_kds, $newRoleId);
        $kdsStmt->execute();
        $kdsStmt->close();
    }
}
