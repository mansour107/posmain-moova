...
if ($rollname === null) {
    ...
    $show_payroll_report = isset($_POST['show_payroll_report']) ? 1 : 0; 

    $show_hr_report = isset($_POST['show_hr_report']) ? 1 : 0;

// ملاحظه هامه .. يجب تعديل هذا الجزءعند اضافه المدخلات له 
...
SET 
`rollname`= '$rollname' ,
`is_fav_users`= '$is_fav_users',
`show_users`= '$show_users',
`add_users`= '$add_users',
`edit_users`= '$edit_users',
`delete_users`= '$delete_users',
`is_fav_general_entrys`= '$is_fav_general_entrys',
`show_general_entrys`= '$show_general_entrys',
`add_general_entrys`= '$add_general_entrys',
...
`is_fav_funds`= '$is_fav_funds',
`show_funds`= '$show_funds',
`add_funds`= '$add_funds',
`edit_funds`= '$edit_funds',
`delete_funds`= '$delete_funds',
`is_fav_banks`= '$is_fav_banks',
`show_banks`= '$show_banks',
`add_banks`= '$add_banks',
`edit_banks`= '$edit_banks',
`delete_banks`= '$delete_banks',
`is_fav_stock`= '$is_fav_stock',
`show_stock`= '$show_stock',
`add_stock`= '$add_stock',
`edit_stock`= '$edit_stock',
`delete_stock`= '$delete_stock',
`is_fav_expenses`= '$is_fav_expenses',
`show_expenses`= '$show_expenses',
`add_expenses`= '$add_expenses',
`edit_expenses`= '$edit_expenses',
`delete_expenses`= '$delete_expenses',
`is_fav_revenuses`= '$is_fav_revenuses',
`show_revenuses`= '$show_revenuses',
`add_revenuses`= '$add_revenuses',
`edit_revenuses`= '$edit_revenuses',
`delete_revenuses`= '$delete_revenuses',
`is_fav_credits`= '$is_fav_credits',
`show_credits`= '$show_credits',
`add_credits`= '$add_credits',
`edit_credits`= '$edit_credits',
`delete_credits`= '$delete_credits',
`is_fav_depits`= '$is_fav_depits',
`show_depits`= '$show_depits',
...
`is_fav_assets`= '$is_fav_assets',
`show_assets`= '$show_assets',
`add_assets`= '$add_assets',
`edit_assets`= '$edit_assets',
`delete_assets`= '$delete_assets',
`is_fav_rentables`= '$is_fav_rentables',
`show_rentables`= '$show_rentables',
`add_rentables`= '$add_rentables',
`edit_rentables`= '$edit_rentables',
`delete_rentables`= '$delete_rentables',
`is_fav_employees`= '$is_fav_employees',
`show_employees`= '$show_employees',
`add_employees`= '$add_employees',
`edit_employees`= '$edit_employees',
`delete_employees`= '$delete_employees',
`is_fav_items`= '$is_fav_items',
`show_items`= '$show_items',
`add_items`= '$add_items',
`edit_items`= '$edit_items',
`delete_items`= '$delete_items',
`is_fav_item_groups`= '$is_fav_item_groups',
`show_item_groups`= '$show_item_groups',
`add_item_groups`= '$add_item_groups',
`edit_item_groups`= '$edit_item_groups',
`delete_item_groups`= '$delete_item_groups',
`is_fav_sales`= '$is_fav_sales',
`show_sales`= '$show_sales',
`add_sales`= '$add_sales',
`edit_sales`= '$edit_sales',
`delete_sales`= '$delete_sales',
`is_fav_resale`= '$is_fav_resale',
`show_resale`= '$show_resale',
`add_resale`= '$add_resale',
`edit_resale`= '$edit_resale',
`delete_resale`= '$delete_resale',
`is_fav_purcases`= '$is_fav_purcases',
`show_purchases`= '$show_purchases',
`add_purchases`= '$add_purchases',
`edit_purchases`= '$edit_purchases',
`delete_purchases`= '$delete_purchases',
`is_fav_repurchases`= '$is_fav_repurchases',
`show_repurchases`= '$show_repurchases',
`add_repurchases`= '$add_repurchases',
`edit_repurchases`= '$edit_repurchases',
`delete_repurchases`= '$delete_repurchases',
`is_fav_recive`= '$is_fav_recive',
`show_recive`= '$show_recive',
`add_recive`= '$add_recive',
`edit_recive`= '$edit_recive',
`delete_recive`= '$delete_recive',
`show_payment`= '$show_payment',
`is_fav_payment`= '$is_fav_payment',
`add_payment`= '$add_payment',
`edit_payment`= '$edit_payment',
`delete_payment`= '$delete_payment',
`is_fav_clinic_clients`= '$is_fav_clinic_clients',
`show_clinic_clients`= '$show_clinic_clients',
`add_clinic_clients`= '$add_clinic_clients',
`edit_clinic_clients`= '$edit_clinic_clients',
`delete_clinic_clients`= '$delete_clinic_clients',
`is_fav_reservations`= '$is_fav_reservations',
...
`is_fav_drugs`= '$is_fav_drugs',
`show_drugs`= '$show_drugs',
`add_drugs`= '$add_drugs',
`edit_drugs`= '$edit_drugs',
`delete_drugs`= '$delete_drugs',
`is_fav_client_profile`= '$is_fav_client_profile',
`show_client_profile`= '$show_client_profile',
`add_client_profile`= '$add_client_profile',
`edit_client_profile`= '$edit_client_profile',
`delete_client_profile`= '$delete_client_profile',
`is_fav_advanced_clients`= '$is_fav_advanced_clients',
`show_advanced_clients`= '$show_advanced_clients',
`add_advanced_clients`= '$add_advanced_clients',
`edit_advanced_clients`= '$edit_advanced_clients',
`delete_advanced_clients`= '$delete_advanced_clients',
`is_fav_chances`= '$is_fav_chances',
`show_chances`= '$show_chances',
`add_chances`= '$add_chances',
`edit_chances`= '$edit_chances',
`delete_chances`= '$delete_chances',
`is_fav_attandance`= '$is_fav_attandance',
`show_attandance`= '$show_attandance',
`add_attandance`= '$add_attandance',
`edit_attandance`= '$edit_attandance',
`delete_attandance`= '$delete_attandance',
`is_fav_calls`= '$is_fav_calls',
`show_calls`= '$show_calls',
`add_calls`= '$add_calls',
`edit_calls`= '$edit_calls',
`delete_calls`= '$delete_calls',
`is_fav_journals`= '$is_fav_journals',
`show_journals`= '$show_journals',
`add_journals`= '$add_journals',
`edit_journals`= '$edit_journals',
`delete_journals`= '$delete_journals',
`show_gl_reports`= '$show_gl_reports',
`show_clinic_reports`= '$show_clinic_reports',
`show_rent_reports`= '$show_rent_reports',
`show_payroll_report`= '$show_payroll_report',
`show_hr_report`= '$show_hr_report',
`sid_entry`= '$sid_entry',
`sid_stock`= '$sid_stock',
`sid_sales`= '$sid_sales',
